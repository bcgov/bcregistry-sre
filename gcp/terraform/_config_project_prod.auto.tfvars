prod_projects = {
        ...
        databases = [
          {
            ...
            database_role_assignment = {
              readonly  = ["sa-notebook@c4hnrd-prod.iam.gserviceaccount.com", "sa-job@gtksf3-prod.iam.gserviceaccount.com", "758264625079-compute@developer.gserviceaccount.com", "vikas.singh@gov.bc.ca", "darci.denis@gov.bc.ca", "jia.xu@gov.bc.ca", "sumesh.kariyil@gov.bc.ca", "tyson.graham@gov.bc.ca", "varek.boettcher@gov.bc.ca", "michelle.hohertz@gov.bc.ca", "david.draker@gov.bc.ca", "Brett.cassidy@gov.bc.ca", "jay.sharp@gov.bc.ca", "olga.potiagalova@gov.bc.ca", "james.mcfarlane@gov.bc.ca", "john.a.m.lane@gov.bc.ca", "sa-strr-analytics@bcrbk9-prod.iam.gserviceaccount.com", "patty.stemkens@gov.bc.ca", "melissa.stanton@gov.bc.ca", "jimmy.palelil@gov.bc.ca", "monica.mow@gov.bc.ca", "pam.sherwood@gov.bc.ca", "harshiv.bagha@gov.bc.ca", "Argus.1.Chiu@gov.bc.ca", "rajandeep.kaur@gov.bc.ca", "genevieve.primeau@gov.bc.ca"]
        ...
        databases = [
          {
            ...
            owner   = "user4ca"
            database_role_assignment = {
              readonly  = ["dietrich.wolpert@gov.bc.ca", "vysakh.menon@gov.bc.ca", "megan.a.wong@gov.bc.ca", "ketaki.deodhar@gov.bc.ca", "thayne.werdal@gov.bc.ca", "Argus.1.Chiu@gov.bc.ca", "rajandeep.kaur@gov.bc.ca"]
              readwrite = ["sa-api"]
              admin     = ["sa-db-migrate"]
            }
          }
        ...
        databases = [
          {
            ...
            owner   = "notifyuser"
            database_role_assignment = {
              readonly  = ["dietrich.wolpert@gov.bc.ca", "megan.a.wong@gov.bc.ca", "vysakh.menon@gov.bc.ca", "ketaki.deodhar@gov.bc.ca", "thayne.werdal@gov.bc.ca", "steven.chen@gov.bc.ca", "eve.deng@gov.bc.ca", "omid.x.zamani@gov.bc.ca", "meng.dong@gov.bc.ca", "Argus.1.Chiu@gov.bc.ca", "rajandeep.kaur@gov.bc.ca"]
              readwrite = ["sa-api"]
              admin     = ["sa-db-migrate"]
            }
          }
        ...
        databases = [
          {
            ...
            owner   = "auth"
            database_role_assignment = {
              readonly  = ["ketaki.deodhar@gov.bc.ca", "dietrich.wolpert@gov.bc.ca", "vysakh.menon@gov.bc.ca", "jia.xu@gov.bc.ca", "sumesh.kariyil@gov.bc.ca", "megan.a.wong@gov.bc.ca", "thayne.werdal@gov.bc.ca", "anushka.halder@gov.bc.ca", "Argus.1.Chiu@gov.bc.ca", "rajandeep.kaur@gov.bc.ca"]
  ...
  "bor-prod" = {
    ...
    service_accounts = {
      ...
      sa-api = {
        roles       = ["projects/yfjq17-prod/roles/roleapi", "roles/cloudsql.instanceUser"]
        description = "Service Account for running api services"
      },
      sa-queue = {
        ...
        databases = [
          {
            ...
            owner   = "business-api"
            database_role_assignment = {
              readonly  = ["sa-lear-db-standby", "sa-solr-importer", "sa-notebook", "vikas.singh@gov.bc.ca", "thayne.werdal@gov.bc.ca", "david.li@gov.bc.ca", "dietrich.wolpert@gov.bc.ca", "megan.a.wong@gov.bc.ca", "kial.jinnah@gov.bc.ca", "eve.deng@gov.bc.ca", "david.mckinnon@gov.bc.ca", "mihai.dinu@gov.bc.ca"]
        ...
        databases = [
          {
            ...
            owner   = "userHQH"
            database_role_assignment = {
              readonly  = ["kial.jinnah@gov.bc.ca", "sa-solr-importer", "david.mckinnon@gov.bc.ca", "mihai.dinu@gov.bc.ca", "Argus.1.Chiu@gov.bc.ca", "rajandeep.kaur@gov.bc.ca"]
        ...
        databases = [
          {
            ...
            owner   = "user4ca"
            database_role_assignment = {
              readonly  = ["eve.deng@gov.bc.ca", "omid.x.zamani@gov.bc.ca", "Argus.1.Chiu@gov.bc.ca", "rajandeep.kaur@gov.bc.ca"]
        ...
        databases = [
          {
            ...
            owner   = "strr"
            database_role_assignment = {
              readonly = ["anushka.halder@gov.bc.ca",
                "dietrich.wolpert@gov.bc.ca",
                "james.mcfarlane@gov.bc.ca",
                "mike.huffman@gov.bc.ca",
                "monica.mow@gov.bc.ca",
