other_projects = {
  ...
  "bor-sandbox" = {
    ...
    service_accounts = {
      ...
      sa-api = {
        roles       = ["projects/yfjq17-tools/roles/roleapi", "roles/cloudsql.instanceUser"]
        description = "Service Account for running api services"
      },
      sa-queue = {
  ...
  "ppr-sandbox" = {
    ...
    service_accounts = {
      ...
      sa-job = {
        roles       = ["projects/eogruh-sandbox/roles/rolejob", "roles/cloudsql.instanceUser"]
        description = "Service Account for running job services"
      },
      sa-api = {
  ...
  "search-sandbox" = {
    ...
    service_accounts = {
      ...
      sa-api = {
        roles       = ["projects/k973yf--tools/roles/roleapi", "roles/cloudsql.instanceUser"]
        description = "Service Account for running api services"
      },
      sa-queue = {
