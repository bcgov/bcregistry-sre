...
Custom CI images live under [`images/`](images/). To rebuild and publish one (e.g. the postgres image used by backend CI), see [`images/postgres-ci/README.md`](images/postgres-ci/README.md).
